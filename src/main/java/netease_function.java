...
public class netease_function extends Function{
	public static ArrayList<String> mail=new ArrayList<String>();

	public netease_function(String dir, int x, int y, OutputStream writeProgress) {
 ...
 */
	public void saveInboxData(AndroidDriver driver,String dataName) throws Exception {
		...
		basePath.add("//*[@resource-id='com.netease.mobimail:id/iv_mail_list_folder']");
		basePath.add("//*[@resource-id='com.netease.mobimail:id/mail_folder_list_item_name' and @text= '收件箱']");
		String baseName="网易邮箱-收件箱-";
					...
					for (MobileElement mobileElement : list) {
						...
						if (isElementExits("id", "com.netease.mobimail:id/mail_list_item_from", mobileElement)) {
							...
							if (isElementExits("id", "com.netease.mobimail:id/mail_list_item_summary", mobileElement)) {
								summary=mobileElement.findElementById("com.netease.mobimail:id/mail_list_item_summary").getText();
							}else {
								summary="无";
							}
...
//								attachments.add(subject);
								...
								//记录每一个文件的下载路径
								String itemName=time+" "+from+" "+subject;
								//map中的key
								...
								//基础路径+文件xpath=文件总路径
								filePath.add("//*[@resource-id='com.netease.mobimail:id/mail_list_item_subject' and @text='"+subject+"']");
							...
							ps.append("<lv>"+replace(summary)+"</lv>"+"\n");
...
/*												if (isElementExits("id", "com.netease.mobimail:id/mail_list_item_attach", mobileElement2)) {
												...
												do {
													...
													if (contentList.size()>0) {
														for (MobileElement contentElement : contentList) {
															try {
																if (!contentElement.getText().equals("")||mobileElement.getText()!=null) {
																	content=content+replace(contentElement.getText());
																}
															} catch (Exception e) {
																continue;
															}
	...
	//
											try {
												if (!contentElement.getText().equals("")||contentElement.getText()!=null) {
													content=content+replace(contentElement.getText());
												}
											} catch (Exception e) {
			...
			if (lastList.size()>0){
				...
				if (isElementExits("id", "com.netease.mobimail:id/mail_list_item_from", lastElement)) {
					...
					if (isElementExits("id", "com.netease.mobimail:id/mail_list_item_summary", lastElement)) {
						summary=lastElement.findElementById("com.netease.mobimail:id/mail_list_item_summary").getText();
...
//										}
	...
	public void saveDraftBoxData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("//*[@resource-id='com.netease.mobimail:id/iv_mail_list_folder']");
		basePath.add("//*[@resource-id='com.netease.mobimail:id/mail_folder_list_item_name' and @text= '草稿箱']");
		String baseName="网易邮箱-草稿箱-";
...
//												}
												...
												do {
													...
													if (contentList.size()>0) {
														for (MobileElement contentElement : contentList) {
															try {
																if (!contentElement.getText().equals("")||mobileElement.getAttribute("content-desc")!=null) {
																	content=content+replace(contentElement.getText());
																}
															} catch (Exception e) {
																continue;
...
//										}
	...
	public void saveOutboxData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("//*[@resource-id='com.netease.mobimail:id/iv_mail_list_folder']");
		basePath.add("//*[@resource-id='com.netease.mobimail:id/mail_folder_list_item_name' and @text= '已发送']");
		String baseName="网易邮箱-发件箱-";
...
//										}
	...
	public void saveRedFlagMailData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("//*[@resource-id='com.netease.mobimail:id/iv_mail_list_folder']");
		basePath.add("//*[@resource-id='com.netease.mobimail:id/mail_folder_list_item_name' and @text= '红旗邮件']");
		String baseName="网易邮箱-红旗邮件-";
...
//										}
	...
	public void saveSubscribeMailData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("//*[@resource-id='com.netease.mobimail:id/iv_mail_list_folder']");
		basePath.add("//*[@resource-id='com.netease.mobimail:id/mail_folder_list_item_name' and @text= '订阅邮件']");
		String baseName="网易邮箱-订阅邮件-";
...
//										}
	...
	public void saveAdvertisementMailData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("//*[@resource-id='com.netease.mobimail:id/iv_mail_list_folder']");
		basePath.add("//*[@resource-id='com.netease.mobimail:id/mail_folder_list_item_name' and @text= '广告邮件']");
		String baseName="网易邮箱-广告邮件-";
...
//										}
	...
	public void saveSpamData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("//*[@resource-id='com.netease.mobimail:id/iv_mail_list_folder']");
		basePath.add("//*[@resource-id='com.netease.mobimail:id/mail_folder_list_item_name' and @text= '垃圾邮件']");
		String baseName="网易邮箱-垃圾邮件-";
...
//										}
	...
	public void saveDeletedData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("//*[@resource-id='com.netease.mobimail:id/iv_mail_list_folder']");
		basePath.add("//*[@resource-id='com.netease.mobimail:id/mail_folder_list_item_name' and @text= '已删除']");
		String baseName="网易邮箱-已删除-";
...
//										}
	...
	public void downloadFileMethod(AndroidDriver driver,String fileName,OutputStream writeProgress) {
		...
		try {
			...
			while (!isElementExits("id", "com.netease.mobimail:id/iv_mail_list_folder", driver)) {
				driver.navigate().back();
				Thread.sleep(2000);
			}
			...
			do {
				lastPageSource=nowPageSource;
				driver.swipe(x/2, y*2/10,x/2,y*8/10,1000);
				Thread.sleep(3000);
				nowPageSource=driver.getPageSource();
			}while (!lastPageSource.equals(nowPageSource));
			...
			String lastPath=(String) filePath.get(filePath.size()-1);
			if (!isElementExits("xpath", lastPath, driver)){
				driver.swipe(x/2, y*8/10, x/2, y*2/10, 1000);
				Thread.sleep(3000);
			}
			List<MobileElement> elements = driver.findElementsByXPath(lastPath);
