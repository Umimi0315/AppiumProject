...
public class QQmail_function extends Function{
	public static ArrayList<String> mail=new ArrayList<String>();
//	public static int mailnumber=0;
	public QQmail_function(String dir, int x, int y, OutputStream writeProgress) {
	...
	public void saveInboxData(AndroidDriver driver,String dataName) throws Exception {
		...
		basePath.add("//*[@class='android.widget.TextView' and @text= '收件箱​']");
		String baseName="QQ邮箱-收件箱-";
...
//    	ps.append("<Tln>"+"\n");
			...
			do {
				...
				List<MobileElement> list=driver.findElementsByXPath("//android.widget.ListView[contains(@resource-id, 'com.tencent.androidqqmail:id/a3w')]/android.widget.RelativeLayout");
				if (list.size()>0) {
					for (MobileElement mobileElement : list) {
						if (isElementExits("xpath", "//*[@class= 'android.view.View' and @index= '0']", mobileElement)) {
							if (mobileElement.findElementByXPath("//*[@class= 'android.view.View' and @index= '0']").getAttribute("content-desc").contains("带附件，")) {
								...
								//记录每一个文件的下载路径
								String itemName=mobileElement.findElementByXPath("//*[@class= 'android.view.View' and @index= '0']").getAttribute("content-desc");
								//map中的key
								...
								filePath.add("//*[@class='android.view.View' and @content-desc='"+itemName+"']");
	...
	public void saveStarMailData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("//*[@class='android.widget.TextView' and @text= '星标邮件​']");
		String baseName="QQ邮箱-星标邮件-";
...
//    	ps.append("<Tln>"+"\n");
	...
	public void saveGroupMailData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("swipe");
		basePath.add("//*[@class='android.widget.TextView' and @text= '群邮件​']");
		String baseName="QQ邮箱-群邮件-";
...
//    	ps.append("</Tln>"+"\n");
	...
	public void saveDraftBoxData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("swipe");
		basePath.add("//*[@class='android.widget.TextView' and @text= '草稿箱​']");
		String baseName="QQ邮箱-草稿箱-";
...
//    	ps.append("</Tln>"+"\n");
	...
	public void saveSentData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("swipe");
		basePath.add("//*[@class='android.widget.TextView' and @text= '已发送​']");
		String baseName="QQ邮箱-已发送-";
...
//    	ps.append("</Tln>"+"\n");
	...
	public void saveDeletedData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("swipe");
		basePath.add("//*[@class='android.widget.TextView' and @text= '已删除​']");
		String baseName="QQ邮箱-已删除-";
...
//    	ps.append("<Tln>"+"\n");
	...
	public void saveTrashCanData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("swipe");
		basePath.add("//*[@class='android.widget.TextView' and @text= '垃圾箱​']");
		String baseName="QQ邮箱-垃圾箱-";
...
//    	ps.append("</Tln>"+"\n");
	...
	public void saveImportantContactMailData(AndroidDriver driver,String dataName) throws Exception {
		...
		List<String> basePath=new ArrayList<String>();
		basePath.add("//*[contains(@content-desc,'重要联系人')]");
		String baseName="QQ邮箱-重要联系人邮件-";
...
//    	ps.append("<Tln>"+"\n");
			...
			do {
				lastPageSource=nowPageSource;
				//Screenshot(driver, dataName);
				List<MobileElement> list=driver.findElementsByXPath("//androidx.recyclerview.widget.RecyclerView[contains(@resource-id, 'com.tencent.androidqqmail:id/arj')]/android.widget.RelativeLayout");
				if (list.size()>0) {
					for (MobileElement mobileElement : list) {
