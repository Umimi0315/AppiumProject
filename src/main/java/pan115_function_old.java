...
public class pan115_function_old extends Function{
	public pan115_function_old(String dir, int x, int y, OutputStream writeProgress) {
				...
				if (list.size()>0) {
					for (MobileElement mobileElement : list) {
						if (isElementExits("id", "com.ylmf.androidclient:id/filename", mobileElement)&&
							...
							attachments.add(mobileElement.findElementById("com.ylmf.androidclient:id/filename").getText());
...
//    	ps.append("<Tln>"+"\n");
	...
	public void downloadFileMethod(AndroidDriver driver,String fileName,OutputStream writeProgress){
		try {
			...
			driver.findElementById("com.ylmf.androidclient:id/iv_menu_search").click();
			Thread.sleep(5000);
			Util.writeProgress(50, 0, "正在搜索文件", writeProgress);
			driver.findElementById("com.ylmf.androidclient:id/search_src_text").click();
			Thread.sleep(2000);
			driver.findElementById("com.ylmf.androidclient:id/search_src_text").sendKeys(fileName);
			Thread.sleep(2000);
...
//			Thread.sleep(2000);
			driver.pressKeyCode(66);
			Thread.sleep(5000);
			excuteAdbShell(switchMuMuIME);
			Thread.sleep(5000);

			driver.findElementByXPath("//*[@resource-id='com.ylmf.androidclient:id/root' and @index= '0']/android.widget.RelativeLayout/android.widget.FrameLayout[@resource-id='com.ylmf.androidclient:id/ff_layout']").click();
			Thread.sleep(5000);
			driver.findElementByXPath("//*[@resource-id='com.ylmf.androidclient:id/title' and @text='下载']").click();
			Thread.sleep(2000);
